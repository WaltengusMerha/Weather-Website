  ...
  fetch(wether_api)
    ...
    .then((data) => {
      ...
      if (data.weather[0].description == "sunny") {
        img.style.backgroundImage = "url('image/weather_bg_sunny.jpg')";
      } else if (
        data.weather[0].description === "light rain" ||
        data.weather[0].description === " rain"
      ) {
        img.style.backgroundImage = "url('image/weather_bg_rain.jpg')";
      } else if (
        ...
        img.style.backgroundImage = "url('image/cloud.jpg')";
      } else if (
        data.weather[0].description == "sky" ||
        data.weather[0].description == "clear sky"
      ) {
        img.style.backgroundImage = "url('image/sky.jpg')";
      } else {
        img.style.backgroundImage = "url('image/weather_bg.jpg')";
      }
